...
#load .jason file with news articles
data<- ndjson::stream_in("C:/Users/mail2/Desktop/Patio_Lawn_and_Garden_5.json")
View(data)

news_2015<- data$reviewText

#Generate DFM
corpus<- toLower(new, keepAcronyms = FALSE) 
...
dfm.tm
dtmss <- removeSparseTerms(dfm.tm, 0.82)
dtmss
